package com.macro.mall.task.quartz;

import cn.hutool.core.io.resource.ResourceUtil;
import com.macro.mall.task.quartz.service.MailService;
 ...
 */
public class MailServiceTest extends MallTaskApplicationTests {
    @Autowired
    ...
    public void sendSimpleMail() {
        mailService.sendSimpleMail("416355221@qq.com", "这是一封简单邮件", "这是一封普通的SpringBoot测试邮件");
    }
