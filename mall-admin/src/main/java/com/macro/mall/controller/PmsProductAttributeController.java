...
public class PmsProductAttributeController {
    ...
    public CommonResult<CommonPage<PmsProductAttribute>> getList(@PathVariable Long cid,
        ...
        Page<PmsProductAttribute> productAttributeList = productAttributeService.getList(cid, type, pageSize, pageNum);
        return CommonResult.success(CommonPagePlus.restPage(productAttributeList));
    }
    ...
    public CommonResult create(@RequestBody PmsProductAttributeParam productAttributeParam) {
        boolean ret = productAttributeService.create(productAttributeParam);
        if (ret) {
    ...
    public CommonResult update(@PathVariable Long id, @RequestBody PmsProductAttributeParam productAttributeParam) {
        boolean ret = productAttributeService.update(id, productAttributeParam);
        if (ret) {
            return CommonResult.success(ret);
        } else {
            return CommonResult.failed();
