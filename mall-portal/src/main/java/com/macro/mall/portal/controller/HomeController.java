...
public class HomeController {
    ...
    @ResponseBody
    public CommonResult<Page<PmsProduct>> recommendProductList(@RequestParam(value = "pageSize", defaultValue = "4") Integer pageSize,
                                                               @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        Page<PmsProduct> productList = homeService.recommendProductList(pageSize, pageNum);
    ...
    @ResponseBody
    public CommonResult<Page<CmsSubject>> getSubjectList(@RequestParam(required = false) Long cateId,
                                                         @RequestParam(value = "pageSize", defaultValue = "4") Integer pageSize,
                                                         @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        Page<CmsSubject> subjectList = homeService.getSubjectList(cateId,pageSize,pageNum);
