...
//    @ResponseBody
//    public CommonResult<CommonPagePlus<EsProduct>> search(@RequestParam(required = false) String keyword,
//                                                          @RequestParam(required = false, defaultValue = "0") Integer pageNum,
//                                                          @RequestParam(required = false, defaultValue = "5") Integer pageSize) {
//        Page<EsProduct> esProductPage = esProductService.search(keyword, pageNum, pageSize);
//        return CommonResult.success(CommonPagePlus.restPage(esProductPage));
//    }
//
...
//    @ResponseBody
//    public CommonResult<CommonPagePlus<EsProduct>> recommend(@PathVariable Long id,
//                                                         @RequestParam(required = false, defaultValue = "0") Integer pageNum,
//                                                         @RequestParam(required = false, defaultValue = "5") Integer pageSize) {
