...
public class SmsFlashPromotionSessionController {
    ...
    public CommonResult create(@RequestBody SmsFlashPromotionSession promotionSession) {
        boolean ret = flashPromotionSessionService.create(promotionSession);
        if (ret) {
    ...
    public CommonResult update(@PathVariable Long id, @RequestBody SmsFlashPromotionSession promotionSession) {
        boolean ret = flashPromotionSessionService.update(id, promotionSession);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult updateStatus(@PathVariable Long id, Integer status) {
        boolean ret = flashPromotionSessionService.updateStatus(id, status);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult delete(@PathVariable Long id) {
        boolean ret = flashPromotionSessionService.delete(id);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
