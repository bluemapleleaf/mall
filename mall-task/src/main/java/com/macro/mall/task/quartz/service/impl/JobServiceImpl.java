package com.macro.mall.task.quartz.service.impl;
...
import com.macro.mall.task.quartz.util.JobUtil;
import com.macro.mall.qrtz.service.impl.QrtzJobDetailsRepositoryImpl;
...
@Service
@Slf4j
public class JobServiceImpl extends QrtzJobDetailsRepositoryImpl implements JobService {
    ...
    public Page<JobAndTrigger> list(Integer currentPage, Integer pageSize) {
        ...
        return getJobAndTriggerList(page);
    }
}
