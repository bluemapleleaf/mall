...
public class SmsHomeBrandController {
    ...
    public CommonResult create(@RequestBody List<SmsHomeBrand> homeBrandList) {
        boolean ret = homeBrandService.create(homeBrandList);
        if (ret) {
    ...
    public CommonResult updateSort(@PathVariable Long id, Integer sort) {
        boolean ret = homeBrandService.updateSort(id, sort);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult delete(@RequestParam("ids") List<Long> ids) {
        boolean ret = homeBrandService.delete(ids);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult updateRecommendStatus(@RequestParam("ids") List<Long> ids, @RequestParam Integer recommendStatus) {
        boolean ret = homeBrandService.updateRecommendStatus(ids, recommendStatus);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
