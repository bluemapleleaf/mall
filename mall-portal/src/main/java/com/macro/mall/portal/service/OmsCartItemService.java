 ...
 */
public interface OmsCartItemService extends OmsCartItemRepository {
    /**
     ...
     * 修改某个购物车商品的数量
     */
    boolean updateQuantity(Long id, Long memberId, Integer quantity);

    /**
     * 批量删除购物车中的商品
     */
    boolean delete(Long memberId,List<Long> ids);
