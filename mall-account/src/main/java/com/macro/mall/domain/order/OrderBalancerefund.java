...
@TableName("ams_order_balancerefund")
@ApiModel(value="AmsOrderBalancerefund对象", description="")
public class OrderBalancerefund extends OrderBase implements Serializable {
