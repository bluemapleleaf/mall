...
public class OmsCartItemController {
    ...
    public CommonResult add(@RequestBody OmsCartItem cartItem) {
        boolean ret = cartItemService.add(cartItem);
        if (ret) {
    ...
    public CommonResult updateQuantity(@RequestParam Long id,
        ...
        boolean ret = cartItemService.updateQuantity(id, memberService.getCurrentMember().getId(), quantity);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult delete(@RequestParam("ids") List<Long> ids) {
        boolean ret = cartItemService.delete(memberService.getCurrentMember().getId(), ids);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult clear() {
        boolean ret = cartItemService.clear(memberService.getCurrentMember().getId());
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
