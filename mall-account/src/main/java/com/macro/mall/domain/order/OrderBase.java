...
public class OrderBase implements Serializable {
    ...
    @ApiModelProperty(value = "账务平台B户客户号")
    private String yyBusinessId;

    @ApiModelProperty(value = "可退额")
    private BigDecimal suramont;

    @ApiModelProperty(value = "核心记账结果")
    private AccountResult accountResult;

    @ApiModelProperty(value = "自定义记账参数")
    private List<EntryItemParam> entryItemParams;
}
