...
public class SmsFlashPromotionController {
    ...
    public CommonResult create(@RequestBody SmsFlashPromotion flashPromotion) {
        boolean ret = flashPromotionService.create(flashPromotion);
        if (ret) {
    ...
    public Object update(@PathVariable Long id, @RequestBody SmsFlashPromotion flashPromotion) {
        boolean ret = flashPromotionService.update(id, flashPromotion);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public Object delete(@PathVariable Long id) {
        boolean ret = flashPromotionService.delete(id);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public Object update(@PathVariable Long id, Integer status) {
        boolean ret = flashPromotionService.updateStatus(id, status);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public Object getItem(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        Page<SmsFlashPromotion> flashPromotionList = flashPromotionService.list(keyword, pageSize, pageNum);
