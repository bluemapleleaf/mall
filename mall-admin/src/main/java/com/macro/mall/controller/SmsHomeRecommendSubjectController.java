...
public class SmsHomeRecommendSubjectController {
    ...
    public CommonResult create(@RequestBody List<SmsHomeRecommendSubject> homeBrandList) {
        boolean ret = recommendSubjectService.create(homeBrandList);
        if (ret) {
    ...
    public CommonResult updateSort(@PathVariable Long id, Integer sort) {
        boolean ret = recommendSubjectService.updateSort(id, sort);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult delete(@RequestParam("ids") List<Long> ids) {
        boolean ret = recommendSubjectService.delete(ids);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult updateRecommendStatus(@RequestParam("ids") List<Long> ids, @RequestParam Integer recommendStatus) {
        boolean ret = recommendSubjectService.updateRecommendStatus(ids, recommendStatus);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
