...
public class SmsHomeAdvertiseController {
    ...
    public CommonResult create(@RequestBody SmsHomeAdvertise advertise) {
        boolean ret = advertiseService.create(advertise);
        if (ret) {
    ...
    public CommonResult delete(@RequestParam("ids") List<Long> ids) {
        boolean ret = advertiseService.delete(ids);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult updateStatus(@PathVariable Long id, Integer status) {
        boolean ret = advertiseService.updateStatus(id, status);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
    ...
    public CommonResult update(@PathVariable Long id, @RequestBody SmsHomeAdvertise advertise) {
        boolean ret = advertiseService.update(id, advertise);
        if (ret) {
            return CommonResult.success(ret);
        }
        return CommonResult.failed();
